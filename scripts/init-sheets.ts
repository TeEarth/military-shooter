...
async function main() {
  ...
  await seedIfEmpty("Weapons", [
    ...
    { id: "double_pistol", name: "Double Pistol", unlockType: "STAGE", unlockValue: 5, priceCoin: 0, priceDiamond: 0, priceTicket: 0, damage: 20, fireRate: 2, fireMode: "single", projectileCount: 1, accuracy: 50, magazineSize: 16, reloadTime: 5, critChance: 8, critDamage: 300, dailyAmmo: 80, spreadDegrees: 4, sprite: roundBullet },
