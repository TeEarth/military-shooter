...
import { getClaimableMissionCount } from "@/lib/db/mission";
...
export default async function HomePage() {
  ...
  const [character, vipProgress, income, mail, equippedWeaponId, claimableMissionCount, dailyLogin] = await Promise.all([
    ...
    getClaimableMissionCount(player.id),
    getDailyLoginStatus(player.id),
  ]);
